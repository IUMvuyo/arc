...
// what you said you'd do, and what you did. The gap between them is the point.
export function Diptych({ beat }: { beat: Beat }) {
  ...
  return (
    <section className="px-6 py-24 sm:px-10 md:px-16 md:py-32">
      {beat.headline ? (
        <Reveal variant="hold">
          <p className="mb-14 max-w-reading font-body text-xs uppercase tracking-[0.35em] text-accent">
            {beat.headline}
          </p>
        </Reveal>
      ) : null}
