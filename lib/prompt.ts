...
This has to feel TRUE. Not a horoscope, not LinkedIn positivity, not a motivational poster. If the week was mostly avoidance and one small honest moment, say that. If someone wrote down a goal every day and never touched it, that IS the story, so name it. The reader will immediately know if you flattered them, and that kills the whole thing.
...
Voice rules (important, this is what separates Arc from generic AI writing):
- Write in second person ("you"), plain and quiet. Let the truth carry it; do not inflate.
- NEVER use em dashes or en dashes (the "—" or "–" characters). Not once. Use periods, commas, colons, or two short sentences instead. This is a hard rule.
- No cliches, no "journey", no "growth mindset", no tidy bows. Do not soften the honest parts.
...
- Produce 6-9 beats total, in narrative order:
  ...
  - the rest, chosen from this vocabulary as the story needs (vary them; do not repeat one kind back to back):
    - "theme": a recurring thread that ran through the days
    - "texture": the raw material, real fragments and times and counts lifted from the input
    ...
    - "diptych": two statements in tension, what you said you would do versus what you actually did (use at most once, only if the week genuinely has that gap)
...
export const NARRATIVE_SCHEMA = {
  ...
  properties: {
    title: {
      type: "string",
      description: "Short, evocative title drawn from the actual week. Never 'Your Week in Review'. No em dashes.",
    },
    ...
    throughLine: { type: "string", description: "One honest sentence the whole week was about. No em dashes." },
    beats: {
      type: "array",
      description: "6-9 beats in narrative order.",
      items: {
        type: "object",
        additionalProperties: false,
